...
exec_test 'cd ; pwd'
exec_test 'mkdir test_dir ; cd test_dir ; cd . ; pwd ; cd . ; pwd ; cd .. ; pwd'


# PIPE TESTS
exec_test 'cat tests/lorem.txt | grep arcu | cat -e'
exec_test 'echo test | cat -e | cat -e | cat -e | cat -e'
exec_test 'ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls'
exec_test 'ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls|ls'
...
# REDIRECTIONS
exec_test 'echo "hello" > test.txt'
exec_test 'echo "bye" >> test.txt'
exec_test 'cat < ls > ls'
